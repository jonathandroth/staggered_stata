...
program staggered_sa, eclass
	...
	staggered_helper, i(`i') y(`y') g(`g') t(`t') estimand(`estimand') estimator("SA") neverTreatedValue(`neverTreatedValue') eventTimeStart(`eventTimeStart') eventTimeEnd(`eventTimeEnd')
